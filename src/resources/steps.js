export const stepsResources = [
{
    ...
    instructions: "To help you get ready for the First Step, read the Doctor's Opinion and Chapters 1, 2, and 3 in the Big Book, and Step 1 in the Twelve and Twelve. Write examples of how each of the following have shown up in your life. Include your emotional response to each example, such as pain, anger, shame, guilt, and fear.",
    ...
    subsections: {
      powerlessness: {
        ...
        prompts: [
          ...
          "PROTECTION: These behaviors may include hiding bottles, sneaking alcohol, using breath sprays to cover up, switching liquor stores",
      ...
      unmanageability: {
        ...
        prompts: [
          ...
          "LIFE GOAL PROBLEMS: These may refer to education issues, frequent goal changes, frequent geographic moves, frequent relationships, marriages, divorces"
        ]
      }
    }
  },
